...
- `/product/event-model/event-model.md` — Global event model
...
- [ ] Event model — Run `/event-model` for consistent event definitions
...
3. `/product/event-model/event-model.md` (if exists)
