...
This folder contains everything needed to implement bitCaster.
...
- `instructions/incremental/` — 9 milestone instructions (foundation, then 8 sections)

**Design Assets:**
- `design-system/` — Colors, fonts, design tokens
- `data-model/` — Core entities and TypeScript types
- `event-model/` — Domain events and flows
- `shell/` — Application shell components
- `sections/` — 8 section components packages with test instructions
