import type { CreatedMarket, CreatedMarketStatus } from '@/../product/sections/portfolio/types'
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {market.rejectionReason && (
          <p className="text-xs text-rose-500 mt-0.5 truncate">{market.rejectionReason}</p>
        )}
      </div>
